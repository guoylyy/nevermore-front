...
// Both or one of selector and customAttribute must be defined.
    ...
    .run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', 'Upload', 'sessionService', function(taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions, Upload, sessionService){
        ...
        taRegisterTool('insertImage', {
            display: '<button ngf-select="uploadImageFile($file)" ng-model="imageFile"><i class="fa fa-picture-o"></i></button>',
            ...
            uploadImageFile: function ($file) {
                ...
                Upload.upload({
                    ...
                    if(response.data.success) {
                        var imageLink = response.data.data.url;
                        console.log(this);
