...
function($scope, CourseManageFactory, generalService, ToasterTool, ManagementService, AlertTool){
	...
	function commitSearch(searchWord) {
			return CourseManageFactory.search().get({
					"keyword": searchWord
			})
	}
	...
	function loadResources(){
		ManagementService.loadResources(CourseManageFactory, {
	...
	function addResource(){
		...
		var controller = "AddCourseController"
	...
	function richModifyResource(resource){
		...
		var controller = "ModifyCourseInfoController"
	...
	function addExperiment(resource){
		...
		var controller = "ConfigCourseExperimentController"
		var modifyDialog = new ManagementService.ModifyDialog()
